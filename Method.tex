...
This section describes a particular design methodology for modeling and studying robot controllers that is widely used in the swarm robotics community. While other models for studying MAS exist \cite{Bayazit2005, Berman2007, Billard1999, Sugawara2013}, the one being discussed here has the important property of being an iterative method that integrates multiple levels of abstraction of the MAS. This opens up the opportunity for parameter discovery and optimization which is covered in section~\ref{sec:opt}.
